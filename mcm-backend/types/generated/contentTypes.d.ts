...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    industry_case: Schema.Attribute.Relation<
      'oneToOne',
      'api::industry-case.industry-case'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiIndustryCaseIndustryCase
  extends Struct.CollectionTypeSchema {
  collectionName: 'industry_cases';
  info: {
    displayName: 'industry-case';
    pluralName: 'industry-cases';
    singularName: 'industry-case';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::industry-case.industry-case': ApiIndustryCaseIndustryCase;
